...
func (c *sumServiceClient) Sum(ctx context.Context, opts ...grpc.CallOption) (SumService_SumClient, error) {
	stream, err := c.cc.NewStream(ctx, &SumService_ServiceDesc.Streams[0], "/sum.SumService/Sum", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *sumServiceSumClient) Send(m *NumberRequest) error {
...
func (x *sumServiceSumServer) Recv() (*NumberRequest, error) {
	m := new(NumberRequest)
